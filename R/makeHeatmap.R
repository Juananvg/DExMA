...
#'
#' @param resMA Output generated by the differents functions that performs
#' meta-analysis (metaES, metaPvalue, metaRank or metaAnalysisDE)
#'
#'
#' @param typeMethod A character that indicates the method that have been 
#' used to perform meta-analysis. See \code{\link{metaAnalysisDE}} function
